class SharedAccessController < ApplicationController
  ...
  def create
    ...
    if collaborator.blank? || collaborator == current_user
      redirect_to password_records_path, alert: "Invalid user" and return
    end
    ...
    if params[:password_record_id].present?
      ...
      if shared_access.persisted?
        ...
        redirect_to password_records_path, alert: shared_access.errors.full_messages.to_sentence
      end
    else
